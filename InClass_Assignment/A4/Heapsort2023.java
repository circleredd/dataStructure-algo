	...
	public class Heap {
	    ...
	    ***************************************************************************/
	    private static boolean less(Comparable[] pq, int i, int j) {
			int a = (int)pq[i-1], b = (int)pq[j-1];	//將欲比較的兩comparable強制轉型成int
			if(a%2 == 0 && b%2 != 0)	//若一數為奇數，另一數為偶數，將偶數*2後比較
				return a*2 > b;
			else if(a%2 != 0 && b%2 == 0)	//若一數為奇數，另一數為偶數，將偶數*2後比較
				return  a > b*2;
			else							//若兩數都是偶數或都不是偶數，直接比較
				return a > b;
	    }
